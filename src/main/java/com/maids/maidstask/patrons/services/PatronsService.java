...
public class PatronsService {
    ...
    @Autowired
    public PatronsService(JwtService jwtService, PatronRepository patronRepo, PatronMapper patronMapper, Utils utils) {
    ...
    public UpdatePatronResponseDto updatePatronById (Integer id, UpdatePatronRequestDto newData) throws NotFoundException {
        ...
        String newToken = this.jwtService.generateToken(patron);

        return this.patronMapper.toUpdatedPatronResponseDto(patron, newToken);
