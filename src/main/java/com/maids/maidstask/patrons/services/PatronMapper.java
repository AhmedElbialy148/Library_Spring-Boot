...
public class PatronMapper {
    ...
    UpdatePatronResponseDto toUpdatedPatronResponseDto(Patron patron, String token) {
        return UpdatePatronResponseDto.builder()
                ...
                .token(token)
                .build();
//        return new UpdatePatronResponseDto(patron.getUsername(), patron.getEmail(), patron.getAddress(), patron.getPhoneNumber(),token);
    }
}
